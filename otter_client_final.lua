-- OTTER CLIENT - Final Enhanced Version
-- Optimized, Clean, and Production-Ready
-- Version: 2.0.0
...
spawn(function()
    ...
    MainAPI.notificationManager:show("OTTER CLIENT FINAL - Welcome " .. player.DisplayName .. "!", ColorPalettes.ElectricBlue.IRIDESCENT, 5)
end)

-- Apply initial theme
ThemeManager:applyTheme("ElectricBlue")

print("Otter Client Final loaded successfully!")
